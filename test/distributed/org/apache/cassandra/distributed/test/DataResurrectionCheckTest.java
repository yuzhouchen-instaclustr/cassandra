...
public class DataResurrectionCheckTest extends TestBaseImpl
{
    ...
    public void testDataResurrectionCheck() throws Exception
    {
        try
        {
            ...
            System.setProperty(CassandraRelevantProperties.DATA_RESURRECTION_HEARTBEAT_PERIOD.getKey(), "3600000");
        ...
        {
            System.clearProperty(CassandraRelevantProperties.DATA_RESURRECTION_HEARTBEAT_PERIOD.getKey());
        }
    }
