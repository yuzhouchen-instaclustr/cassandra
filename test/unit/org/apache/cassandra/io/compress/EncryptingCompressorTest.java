...
public class EncryptingCompressorTest
{
    ...
    public void setup()
    {
        ...
        encryptingCompressor = EncryptingCompressor.create(map);//new EncryptingCompressor(map, encryptionContext);

        decryptingCompressor = EncryptingCompressor.create(map);//new EncryptingCompressor(map, encryptionContext);
    }
