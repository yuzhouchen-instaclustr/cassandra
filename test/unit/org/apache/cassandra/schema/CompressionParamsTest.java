...
public class CompressionParamsTest
{
    ...
    @Test
    public void serailize_Unencrypted() throws IOException
    {
        serailize(false);
    }

    @Test
    public void serailize_Encrypted() throws IOException
    {
        serailize(true);
    }

    void serailize(boolean encrypted) throws IOException
    {
