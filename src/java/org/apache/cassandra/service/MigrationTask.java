...
public final class MigrationTask extends WrappedRunnable
{
    ...
    public static class MigrationTaskCallback implements IAsyncCallbackWithFailure<Collection<Mutation>>
    {
        ...
        public void response(MessageIn<Collection<Mutation>> message)
        {
            ...
            try
            {
                logger.info("Received response to schema request from {} at {}", message.from, responseTime);
                ...
                logger.debug("Merging of schema from {} received at {} has finished.", message.from, responseTime);
            }
            ...
            finally
            {
                ...
                logger.info("Removing peer {} from submitted migration requests for request which happened at {}",
                            message.from, responseTime);
        ...
        public void onFailure(InetAddress from, RequestFailureReason failureReason)
        {
            ...
            logger.warn(String.format("Migration request from %s has failed with reason %s.", from, failureReason));

            // remove me from set of submitted requests,
