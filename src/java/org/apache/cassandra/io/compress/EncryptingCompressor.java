 ...
 * the instance of this class will be reused from writing to reading stages.
 */
public class EncryptingCompressor implements ICompressor
{
    ...
    public Set<String> supportedOptions()
    {
        return ImmutableSet.<String>builder()
                           .addAll(encryptionContext.getCompressor().supportedOptions())
                           .addAll(ENCRYPTION_OPTIONS).build();
    }
