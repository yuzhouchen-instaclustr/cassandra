...
public class DiagnosticLogOptionsCompositeData
{
    ...
    DiagnosticLogOption.option(DiagnosticLogOption.ARCHIVE_COMMAND,
                               "archive command for audit data",
                               SimpleType.STRING,
                               o -> o.archive_command,
                               (opts, obj) -> opts.archive_command = (String) obj),

    DiagnosticLogOption.option(DiagnosticLogOption.ROLL_CYCLE,
    ...
    DiagnosticLogOption.option(DiagnosticLogOption.MAX_QUEUE_WEIGHT,
